am5.ready(function () {
    ...
    async function loadData(ticker, series, granularity) {
        ...
        console.log(!internalTickers[ticker]);
    ...
    function getTicker(search) {
        ...
        var tickers = [
            ...
            { label: "Bitcoin", subLabel: "XBT/USD", id: "XBTUSD", exchange: "BITMEX" },
            { label: "Bitcoin", subLabel: "BTCUSD", id: "BTCUSD", exchange: "BITFINEX" },
            { label: "Ethereum", subLabel: "ETHUSD", id: "ETHUSD", exchange: "BITFINEX" }
        ];
